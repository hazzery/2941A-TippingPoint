...
#	pragma warning(pop)
	...
	*/
	...
	/**
	 * @namespace	units::revolution
	 * @brief		namespace for unit types and containers representing revolution values
	 * @sa			See unit_t for more information on unit type containers.
	 */
	...
	namespace constants
	{
		 ...
		 * @{
		 */
		using P_I = unit<std::ratio<1>, dimensionless::scalar, std::ratio<1>>;

		static constexpr const unit_t<P_I>																											pi(1);											///< Ratio of a circle's circumference to its diameter.
